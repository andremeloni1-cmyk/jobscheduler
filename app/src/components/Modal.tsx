...
export function Modal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center" role="dialog" aria-modal>
      ...
      <div className="relative z-10 max-h-[92vh] w-full max-w-lg overflow-y-auto rounded-t-3xl bg-white dark:bg-night-900 p-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] shadow-xl dark:shadow-none sm:max-h-[85vh] sm:rounded-3xl">
